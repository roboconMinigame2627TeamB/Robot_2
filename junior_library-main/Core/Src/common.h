...
#define lsfl2 		HAL_GPIO_ReadPin(IP4_PIN)// limit switch for closing gripper
...
#define IP10    	HAL_GPIO_ReadPin(IP10_PIN) //Platform bottom limit switch
#define IP11  		HAL_GPIO_ReadPin(IP11_PIN) //Platform top limit switch
