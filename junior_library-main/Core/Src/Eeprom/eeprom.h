...
#define WRITE_ALL(__ADDRESS__, __EEPROM__)\
    EepromWriteAll(__ADDRESS__, (uint32_t*)&(__EEPROM__), sizeof(__EEPROM__))

#define READ_ALL(__ADDRESS__, __EEPROM__)\
    EepromReadAll(__ADDRESS__, (uint32_t*)&(__EEPROM__), sizeof(__EEPROM__))
 ...
 * 		Function Prototype			  			  *
 *************************************************/
uint32_t EepromWriteAll (uint32_t Address, uint32_t* Eeprom, int size);
void EepromReadAll(uint32_t Address, uint32_t* Eeprom, int size);
